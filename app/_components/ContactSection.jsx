...
const ContactSection = () => {
  return (
    <div
      id="Contact"
      className="p-6 bg-secondEle rounded-xl flex items-center justify-between flex-col gap-6 overflow-x-hidden"
    >
      ...
      <div className="flex justify-center">
        <div className="relative">
          ...
          <button
            ...
            className="relative font-bold shadow-none justify-self-center w-full flex items-center gap-2 px-4 h-fit py-1  duration-200 bg-gradient-to-r from-[#007CF0] to-[#00DFD8] rounded-full"
          >
            Say Hi <FiMail />
          </button>
        </div>
