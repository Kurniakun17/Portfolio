    ...
    <div className="flex flex-col gap-4">
      ...
      >
        <div className="flex flex-col gap-2 md:gap-4 overflow-hidden">
          ...
          >
            a Software engineer based in Indonesia. I have a great interest in
            full-stack development, either it&apos;s a website, iOS Development,
            and multi-platform application.
          </motion.p>
        </div>
      </motion.div>
    </div>
